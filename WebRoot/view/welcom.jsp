   ...
   <title>欢迎，${login.userName}</title>
	    ...
	    <link rel="stylesheet" type="text/css" href="<%=basePath%>/jquery-easyui-1.3.3/themes/default/easyui.css"/>
  	    ...
  	    <script type="text/javascript">
  	    	function show(title,url){
  	    		//判断是否存在这个面板了 isopen
				var isopen = $('#tab').tabs("exists",title);
				if(!isopen){
					$("#tab").tabs('add',{
					title:title,
					selected:true,
  	...
  	<body class="easyui-layout"> 
        ...
        <div data-options="region:'north',split:true" style="height:125px;background-color: #00FFFF;">
          ...
          <h5 style="margin-top:-45px;">欢迎你,${login.userName}</h5>
        </div>
        ...
        <div id="ac" data-options="region:'center'" style="padding:5px;background:#eee;">
